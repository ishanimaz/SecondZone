<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <style><%@include file ="./CSS/Prod.css"%></style>
...
<div class="btn-group">
                      <a class="btn btn-details" href="login.jsp">Details</a>
 <a class="btn btn-success" href="login.jsp">Add to cart</a>
  </div>
                 </div>
              </div>
              </div>
